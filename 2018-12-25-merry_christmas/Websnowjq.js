    ...
    a.fn.websnowjq = function (b) {
        function q() {
            j = document.getElementById("websnowjqcan" + d),
                ...
                o = setInterval(r, 200), t(),
                setInterval(v, 30),
                a(window).resize(function () {
                    a("#websnowjqcan" + d).offset({ top: a(c).offset().top,
        ...
        function s() {
            ...
            this.y = -10,
            this.speed = Math.round(12 * Math.random()) + 1,
            this.width = 8 * Math.random() + 4,
            this.drift = 6 * Math.random()
        }
        function t() {
            k.save(), u();
            for (var a = 0; a < n.length; a++)
                m.beginPath(),
                m.arc(n[a].x, n[a].y, n[a].width, 0, 10 * Math.PI, !1),
                m.fillStyle = "#ffffff",
                m.fill();
        ...
        a("body").append("<canvas width='" + h + "' height='" + g + "' id='websnowjqcan" + d + "' style='" + i + "'></canvas>"), q() } }(jQuery);